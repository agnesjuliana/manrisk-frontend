...
export default function Home() {
  ...
  return (
    <main className="min-h-dvh bg-gradient-to-br from-white via-emerald-400/50 to-white">
      {/* Navigation */}
      <nav className="fixed top-6 left-1/2 -translate-x-1/2 z-50 w-[95%] max-w-6xl">
        <div className="bg-white/80 backdrop-blur-md border border-emerald-100/40 rounded-full shadow-lg">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-6">
              <div className="inline-block px-4 py-2 bg-emerald-100/80 rounded-full text-sm font-semibold text-emerald-700 border border-emerald-200/50">
                ✨ 10,000+ Risk Managers
              </div>
              <h1 className="text-6xl lg:text-7xl font-bold text-gray-900 leading-tight">
                Kelola Risiko dengan Percaya Diri
              </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-6">
              <Link href={user ? "/dashboard" : "/auth/register"} className="flex-1">
                <Button className="w-full bg-emerald-600 hover:bg-emerald-700 h-12 text-lg font-semibold text-white rounded-lg">
              ...
              {!user && (
                <Link href="/auth/login" className="flex-1">
                  <Button variant="outline" className="w-full h-12 text-lg font-semibold border-2 border-gray-300 hover:bg-gray-50 rounded-lg">
                    Masuk
                  </Button>
                </Link>
              )}
          ...
          <div className="relative">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <Card className="border border-emerald-100/50 bg-white shadow-lg hover:shadow-xl transition-shadow">
                  ...
                  <CardContent>
                    ...
                    <p className="text-sm text-emerald-600 font-medium mt-2">↓ 15% dari bulan lalu</p>
                  </CardContent>
                </Card>
                <Card className="border border-emerald-100/50 bg-white shadow-lg hover:shadow-xl transition-shadow">
                  <CardHeader className="pb-2">
              ...
              {/* Main Dashboard Card */}
              <Card className="border border-emerald-100/50 bg-gradient-to-br from-white to-emerald-50/30 shadow-2xl overflow-hidden">
                <div className="bg-gradient-to-br from-emerald-600/85 via-emerald-600/80 to-emerald-700/85 backdrop-blur-sm text-white p-6 pb-4 shadow-lg border border-emerald-400/20">
                  <div className="flex items-center justify-between">
                    <div>
                      <h3 className="text-white text-xl font-semibold">Risk Dashboard</h3>
                      <p className="text-emerald-100 text-sm">Manajemen risiko real-time</p>
                    </div>
                ...
                <CardContent className="pt-6">
                  <div className="space-y-4">
                    ...
                    <div>
                      <div className="flex justify-between items-center mb-2">
                        ...
                        <span className="font-bold text-emerald-700 text-sm">8</span>
                      </div>
                      <div className="w-full bg-gray-200 rounded-full h-3">
                    ...
                    <div>
                      <div className="flex justify-between items-center mb-2">
                        ...
                        <span className="font-bold text-emerald-700 text-sm">13</span>
                      </div>
                      <div className="w-full bg-gray-200 rounded-full h-3">
                  ...
                  {/* Mini Stats */}
                  <div className="grid grid-cols-3 gap-3 mt-6 pt-6 border-t border-emerald-100/50">
      ...
      {/* Features Section */}
      <section className="bg-emerald-50/50 px-6 py-20 border-y border-emerald-100/50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-5xl font-bold text-gray-900 mb-4">Fitur Lengkap untuk</h2>
            <h2 className="text-5xl font-bold text-emerald-600 mb-4">Manajemen Risiko Efektif</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <Card key={idx} className="border border-emerald-100/50 bg-white hover:border-emerald-200 hover:shadow-lg transition-all group cursor-pointer">
                <CardHeader>
                  <div className="p-3 bg-emerald-100 rounded-lg w-fit mb-4 group-hover:bg-emerald-200 transition-colors">
      ...
      <section className="px-6 py-20 max-w-7xl mx-auto">
        <div className="bg-gradient-to-r from-emerald-50 to-emerald-100/50 border border-emerald-200 rounded-2xl p-8 md:p-16">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-white rounded-xl p-8 border border-emerald-200/50 shadow-lg">
              <div className="space-y-6">
                <div className="text-center">
                  <div className="text-5xl font-bold text-emerald-600 mb-2">ISO</div>
                ...
                <div className="bg-emerald-50 rounded-lg p-4 border border-emerald-100">
                  <p className="text-xs font-semibold text-emerald-700 mb-2">KEPATUHAN REGULASI</p>
      ...
      <section className="bg-gradient-to-r from-emerald-600 to-emerald-700 px-6 py-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/auth/register">
              <Button className="bg-white text-emerald-700 hover:bg-emerald-50 h-12 px-10 text-lg font-semibold rounded-lg">
                Mulai Sekarang
              </Button>
            </Link>
          </div>
      ...
      {/* Footer */}
      <footer className="border-t border-emerald-100/50 px-6 py-12 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-600 text-sm">
                <li><a href="#" className="hover:text-emerald-600 transition">Fitur</a></li>
                <li><a href="#" className="hover:text-emerald-600 transition">Pricing</a></li>
                <li><a href="#" className="hover:text-emerald-600 transition">Keamanan</a></li>
              </ul>
            </div>
            <div>
              <h4 className="font-semibold text-gray-900 mb-4">Sumber Daya</h4>
              <ul className="space-y-2 text-gray-600 text-sm">
                <li><a href="#" className="hover:text-emerald-600 transition">Dokumentasi</a></li>
                <li><a href="#" className="hover:text-emerald-600 transition">API</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-600 text-sm">
                <li><a href="#" className="hover:text-emerald-600 transition">Privasi</a></li>
                <li><a href="#" className="hover:text-emerald-600 transition">Syarat & Ketentuan</a></li>
                <li><a href="#" className="hover:text-emerald-600 transition">Compliance</a></li>
              </ul>
            </div>
          </div>
